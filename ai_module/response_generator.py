...
def generate_response(conv: Conversation, analysis_result: Optional[Dict[str, Any]] = None) -> str:
    ...
    system_prompt = (
        ...
        "1. THE \"ONE QUESTION\" RULE: You are STRICTLY FORBIDDEN from asking more than 1 question per message. Even if the script suggests multiple probes, pick the single most relevant one.\n"
        "2. THE \"MATCH ENERGY\" RULE: Look at the user's last message.\n"
        "   - If they sent a short sentence (< 50 chars), you MUST respond with a short sentence + 1 question. Do not send a paragraph.\n"
        "   - If they sent a long detailed reply, you can respond with more depth.\n"
        "3. THE \"NO FLUFF\" RULE: Cut the generic validation (\"That sounds like a really meaningful project...\"). It sounds robotic. Go straight to the next step.\n"
        "4. FORMATTING: Use line breaks to separate your statement from your question. Never bury the question in a paragraph.\n\n"
